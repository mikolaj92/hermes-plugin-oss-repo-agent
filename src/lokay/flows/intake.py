...
async def run_intake_flow(
    *,
    ...
    intake_steps = (
        ...
        "publish_triage_feedback_receipt", "publish_triage_mutation_verification", "publish_triage_close_authorization",
        "close_triage_issue", "verify_triage_issue_closed", "publish_triage_close_verification", "verify_triage_receipt",
        "build_triage_terminal", "filter_issue_eligibility", "select_issue_candidate", "decide_issue_action",
