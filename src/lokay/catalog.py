...
EFFECTORS: tuple[EffectorEntry, ...] = (
    ...
    EffectorEntry(
        ...
        "intake",
        "lokay.steps.poll.poll_eligible_issues",
    ...
    EffectorEntry(
        "decide_issue_action",
        "intake",
        "lokay.steps.issue_direction.decide_issue_action",
    ...
    EffectorEntry(
        "comment_issue_once",
        "intake",
        "lokay.steps.issue_direction.comment_issue_once",
    ...
    EffectorEntry(
        "claim_github_issue",
        "intake",
        "lokay.steps.claim.claim_github_issue",
    ...
    EffectorEntry(
        ...
        "intake",
        "lokay.steps.kanban_intake.ensure_kanban_intake",
    ...
    EffectorEntry(
        "load_kanban_task",
        "issue_to_pr",
        "lokay.steps.issue_to_pr.load_kanban_task",
    ...
    EffectorEntry(
        ...
        "issue_to_pr",
        "lokay.steps.issue_to_pr.parse_issue_ref_from_task",
    ...
    EffectorEntry(
        "create_fix_pr_task",
        "issue_to_pr",
        "lokay.steps.issue_to_pr.create_fix_pr_task",
    ...
    EffectorEntry(
        ...
        "issue_to_pr",
        "lokay.steps.issue_to_pr.complete_kanban_task",
    ...
    EffectorEntry(
        "refresh_clone_base",
        "issue_to_pr",
        "lokay.steps.issue_to_pr.refresh_clone_base",
    ...
    EffectorEntry(
        "prepare_worktree",
        "issue_to_pr",
        "lokay.steps.issue_to_pr.prepare_worktree",
    ...
    EffectorEntry(
        "run_omp_worker",
        "issue_to_pr",
        "lokay.steps.issue_to_pr.run_omp_worker",
    ...
    EffectorEntry(
        ...
        "issue_to_pr",
        "lokay.steps.issue_to_pr.verify_branch_has_commits",
    ...
    EffectorEntry(
        "open_pull_request",
        "issue_to_pr",
        "lokay.steps.issue_to_pr.open_pull_request",
    ...
    EffectorEntry(
        "apply_pr_labels",
        "issue_to_pr",
        "lokay.steps.issue_to_pr.apply_pr_labels",
    ...
    EffectorEntry(
        ...
        "issue_to_pr",
        "lokay.steps.issue_to_pr.write_dispatch_receipt",
    ...
    EffectorEntry(
        ...
        "issue_to_pr",
        "lokay.steps.issue_to_pr.check_worktree_dirty",
    ...
    EffectorEntry(
        ...
        "issue_to_pr",
        "lokay.steps.issue_to_pr.list_controlled_worktrees",
    ...
    EffectorEntry(
        "push_branch",
        "issue_to_pr",
        "lokay.steps.issue_to_pr.push_branch",
    ...
    EffectorEntry(
        "apply_issue_labels",
        "intake",
        "lokay.steps.issue_to_pr.apply_issue_labels",
    ...
    EffectorEntry(
        "list_ai_fix_prs",
        "triage",
        "lokay.steps.triage.list_ai_fix_prs",
    ...
    EffectorEntry(
        "load_pr_fields",
        "triage",
        "lokay.steps.triage.load_pr_fields",
    ...
    EffectorEntry(
        "evaluate_checks",
        "triage",
        "lokay.steps.triage.evaluate_checks",
    ...
    EffectorEntry(
        ...
        "triage",
        "lokay.steps.triage.evaluate_test_evidence",
    ...
    EffectorEntry(
        ...
        "triage",
        "lokay.steps.triage.decide_triage_action",
    ...
    EffectorEntry(
        "claim_pr_assignee",
        "triage",
        "lokay.steps.triage.claim_pr_assignee",
    ...
    EffectorEntry(
        "comment_pr_once",
        "triage",
        "lokay.steps.triage.comment_pr_once",
    ...
    EffectorEntry(
        "merge_pull_request",
        "triage",
        "lokay.steps.triage.merge_pull_request",
    ...
    EffectorEntry(
        "close_linked_issue",
        "triage",
        "lokay.steps.triage.close_linked_issue",
    ...
    EffectorEntry(
        "write_merge_receipt",
        "triage",
        "lokay.steps.triage.write_merge_receipt",
    ...
    EffectorEntry(
        "build_repair_prompt",
        "repair",
        "lokay.steps.repair.build_repair_prompt",
    ...
    EffectorEntry(
        ...
        "repair",
        "lokay.steps.repair.create_review_fix_task",
    ...
    EffectorEntry(
        "block_kanban_task",
        "repair",
        "lokay.steps.repair.block_kanban_task",
    ...
    EffectorEntry(
        ...
        "cleanup",
        "lokay.steps.cleanup.parse_issue_from_branch",
    ...
    EffectorEntry(
        "check_issue_closed",
        "cleanup",
        "lokay.steps.cleanup.check_issue_closed",
    ...
    EffectorEntry(
        ...
        "cleanup",
        "lokay.steps.cleanup.check_no_open_pr_for_branch",
    ...
    EffectorEntry(
        "remove_worktree",
        "cleanup",
        "lokay.steps.cleanup.remove_worktree",
    ...
    EffectorEntry(
        ...
        "cleanup",
        "lokay.steps.cleanup.delete_local_fix_branch",
    ...
    EffectorEntry(
        ...
        "cleanup",
        "lokay.steps.cleanup.release_active_issue_claim",
    ...
    EffectorEntry(
        ...
        "cleanup",
        "lokay.steps.cleanup.write_cleanup_receipt",
    ...
    EffectorEntry(
        ...
        "cleanup",
        "lokay.steps.cleanup_reconcile.reconcile_no_target_cleanup",
    ...
    EffectorEntry(
        ...
        "cleanup",
        "lokay.steps.cleanup.create_maintenance_task",
