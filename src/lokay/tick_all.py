...
def _prefixed_inputs(cfg: Any, *, dry_run: bool, limit: int, run_id: str = "", db_path: str = "") -> tuple[dict[str, Any], dict[str, dict[str, Any]]]:
    ...
    inputs: dict[str, dict[str, Any]] = {
        ...
        "dispatch_read_base_ref": {"base_branch": cfg.base_branch}, "dispatch_read_worktree_inventory": {"worktree_root": cfg.paths.worktree_root, "receipt_path": receipt},
        "dispatch_read_branch_provenance": {"receipt_path": receipt, "worktree_root": cfg.paths.worktree_root}, "dispatch_create_local_branch": {"worktree_root": cfg.paths.worktree_root, "base_branch": cfg.base_branch, "receipt_path": receipt},
        ...
        "dispatch_push_branch": {}, "dispatch_read_pushed_ref": {}, "dispatch_verify_push_oid": {}, "dispatch_update_branch_local_oid": {}, "dispatch_verify_updated_branch_local_oid": {}, "dispatch_read_open_pr_for_branch": {},
